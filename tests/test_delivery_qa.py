...
def _bundle(tmp_path: Path, *, with_zip: bool) -> tuple[Path, ProjectDocument, dict[str, Any]]:
    ...
    manifest = build_final_export_bundle(
        ...
        run_dir=run_dir,
        gate=gate,
        options=FinalExportOptions(include_stems=False, include_stem_audio=False),
