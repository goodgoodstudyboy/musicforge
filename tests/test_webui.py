...
def test_webui_contains_encoded_audio_acceptance_controls():
    ...
    assert "Assurance Watch Signoff" in html
    assert 'id="trust-operations-assurance-watch-signoff-closeout"' in html
    assert 'id="trust-operations-assurance-watch-signoff-sign"' in html
    assert 'id="trust-operations-assurance-watch-signoff-cr"' in html
    assert 'id="trust-operations-assurance-watch-signoff-reset"' in html
    assert 'id="trust-operations-assurance-watch-signoff-export"' in html
    assert 'id="trust-operations-assurance-watch-signoff-zip"' in html
    assert 'id="trust-operations-assurance-watch-signoff-verify"' in html
    assert "/api/trust-operations/assurance-watch/signoffs/toawq-000001/download" in html
    assert "Final Readiness Handoff" in html
    assert 'id="trust-operations-final-readiness-refresh"' in html
    assert 'id="trust-operations-final-readiness-certificate"' in html
    assert 'id="trust-operations-final-readiness-sign"' in html
    assert 'id="trust-operations-final-readiness-cr"' in html
    assert 'id="trust-operations-final-readiness-reset"' in html
    assert 'id="trust-operations-final-readiness-export"' in html
    assert 'id="trust-operations-final-readiness-zip"' in html
    assert 'id="trust-operations-final-readiness-verify"' in html
    assert "/api/trust-operations/final-readiness/download" in html
...
def test_webui_contains_release_workspace_controls():
    ...
    assert "Audio Fix Sprints" in html
    ...
    assert 'id="audio-campaign-release-id"' in html
    assert 'id="audio-campaign-plan-release"' in html
    assert 'id="audio-campaign-preflight-release"' in html
    assert 'id="audio-campaign-create-from-release"' in html
    assert 'id="audio-campaign-release-status"' in html
    assert 'id="audio-campaign-release-link"' in html
    ...
    assert 'id="release-audio-timeline-refresh"' in html
    ...
    assert 'id="release-audio-baseline-list"' in html
    assert 'id="release-audio-regression-response-create"' in html
    assert 'id="release-audio-regression-response-run-safe"' in html
    assert 'id="release-audio-regression-response-signoff"' in html
    assert 'id="release-audio-regression-response-verify"' in html
    assert 'id="release-audio-quality-observatory-list"' in html
    assert 'id="release-audio-quality-observatory-create"' in html
    assert 'id="release-audio-quality-observatory-refresh"' in html
    assert 'id="release-audio-quality-observatory-verify"' in html
    assert 'id="release-audio-quality-action-list"' in html
    ...
    assert 'id="unified-command-center-continuous-review"' in html
    assert 'id="unified-command-center-continuous-review-verify"' in html
    ...
    assert "/audio-campaign-plan/refresh" in html
    assert "/audio-campaign-plan/preflight" in html
    ...
    assert "/api/audio-baselines" in html
    assert "/audio-regression-response/create" in html
    assert "/audio-regression-response/run-safe" in html
    assert "/audio-regression-response/signoff" in html
