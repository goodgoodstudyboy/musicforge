...
from song_agent.release_check.v14_quality import (
    ...
    V144_WAVE1_AFFECTED_FILE_CEILING,
    V144_WAVE1_EXPLICIT_ANY_CEILING,
    V144_WAVE1_EXPLICIT_ANY_FILE_BUDGETS_HASH,
    V144_WAVE1_LAYER_CEILINGS,
...
def _apply_v1421_stabilization_policy(document: dict[str, object]) -> None:
    ...
    document["stabilization"] = {
        ...
        "collector_hotfix": {
            ...
            "corrected_explicit_any_count": V14210_EXPLICIT_ANY_CEILING,
        },
        ...
        "wave1_typing_ratchet": {
            "explicit_any_max_count": V144_WAVE1_EXPLICIT_ANY_CEILING,
            "affected_file_max_count": V144_WAVE1_AFFECTED_FILE_CEILING,
            "layer_budgets": V144_WAVE1_LAYER_CEILINGS,
            "file_budgets_hash": V144_WAVE1_EXPLICIT_ANY_FILE_BUDGETS_HASH,
        },
    }
