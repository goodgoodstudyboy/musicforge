...
_RAW_CHECK_DEFINITIONS: tuple[ReleaseCheckDefinition, ...] = (
    ...
    _callable("v140.reviewer_package_smoke", "v14.0 final reviewer package independent verification", "_v140_reviewer_package_smoke", group="release-check", version="14.0", risk="critical", timeout_seconds=720, tags=("v14", "ga", "reviewer-package", "certification"), profiles=V14_PROFILES, duration_budget_seconds=600, budget_enforced_profiles=V14_PROFILES),
    _callable("v141.quality_debt_closure_smoke", "v14.1 active typing, full-repository lint, complexity, and CI performance ratchet", "_v141_quality_debt_closure_smoke", group="quality", version="14.1", risk="critical", timeout_seconds=180, tags=("v14", "ga", "typing", "lint", "complexity", "performance", "ratchet"), profiles=V14_PROFILES, duration_budget_seconds=120, budget_enforced_profiles=V14_PROFILES),
    _callable("v1421.stabilization_rollback_smoke", "v14.2.1 generated-split rollback and quality-gate recovery", "_v1421_stabilization_rollback_smoke", group="quality", version="14.2.1", risk="critical", timeout_seconds=180, tags=("v14", "ga", "typing", "architecture", "rollback", "ratchet"), profiles=V14_PROFILES, duration_budget_seconds=120, budget_enforced_profiles=V14_PROFILES),
    ...
    _callable("v1426.explicit_any_indirect_target_scope_smoke", "v14.2.6 Explicit Any indirect-target scope collector hotfix", "_v1426_explicit_any_indirect_target_scope_smoke", group="quality", version="14.2.6", risk="critical", timeout_seconds=60, tags=("v14", "ga", "typing", "security", "ratchet"), profiles=V14_PROFILES, duration_budget_seconds=30, budget_enforced_profiles=V14_PROFILES),
    _callable("v1427.explicit_any_derived_uncertain_scope_smoke", "v14.2.7 Explicit Any derived uncertain-flow collector hotfix", "_v1427_explicit_any_derived_uncertain_scope_smoke", group="quality", version="14.2.7", risk="critical", timeout_seconds=60, tags=("v14", "ga", "typing", "security", "ratchet"), profiles=V14_PROFILES, duration_budget_seconds=30, budget_enforced_profiles=V14_PROFILES),
    _callable("v1428.explicit_any_object_alias_scope_smoke", "v14.2.8 Explicit Any object-alias collector hotfix", "_v1428_explicit_any_object_alias_scope_smoke", group="quality", version="14.2.8", risk="critical", timeout_seconds=60, tags=("v14", "ga", "typing", "security", "ratchet"), profiles=V14_PROFILES, duration_budget_seconds=30, budget_enforced_profiles=V14_PROFILES),
    _callable("v1429.explicit_any_alias_dataflow_smoke", "v14.2.9 Explicit Any alias data-flow kernel", "_v1429_explicit_any_alias_dataflow_smoke", group="quality", version="14.2.9", risk="critical", timeout_seconds=60, tags=("v14", "ga", "typing", "security", "ratchet", "dataflow"), profiles=V14_PROFILES, duration_budget_seconds=30, budget_enforced_profiles=V14_PROFILES),
    _callable("v14210.explicit_any_alias_fail_closed_smoke", "v14.2.10 Explicit Any alias fail-closed semantics", "_v14210_explicit_any_alias_fail_closed_smoke", group="quality", version="14.2.10", risk="critical", timeout_seconds=60, tags=("v14", "ga", "typing", "security", "ratchet", "dataflow"), profiles=V14_PROFILES, duration_budget_seconds=30, budget_enforced_profiles=V14_PROFILES),
    _callable("v143.explicit_any_call_effect_dataflow_smoke", "v14.3 Explicit Any generic call-effect data flow", "_v143_explicit_any_call_effect_dataflow_smoke", group="quality", version="14.3.0", risk="critical", timeout_seconds=180, tags=("v14", "ga", "typing", "security", "ratchet", "dataflow"), profiles=V14_PROFILES, duration_budget_seconds=150, budget_enforced_profiles=V14_PROFILES),
    _callable("v1431.call_effect_component_compaction_smoke", "v14.3.1 call-effect component compaction", "_v1431_call_effect_component_compaction_smoke", group="quality", version="14.3.1", risk="critical", timeout_seconds=60, tags=("v14", "ga", "typing", "performance", "ratchet", "dataflow"), profiles=V14_PROFILES, duration_budget_seconds=30, budget_enforced_profiles=V14_PROFILES),
    _callable("v1432.expression_binding_single_pass_smoke", "v14.3.2 expression binding single-pass scan", "_v1432_expression_binding_single_pass_smoke", group="quality", version="14.3.2", risk="critical", timeout_seconds=60, tags=("v14", "ga", "typing", "performance", "ratchet", "dataflow"), profiles=V14_PROFILES, duration_budget_seconds=30, budget_enforced_profiles=V14_PROFILES),
    ...
    _callable("v144.wave1_platform_application_interfaces_smoke", "v14.4 Wave 1 Platform, Application, and Interfaces boundary", "_v144_wave1_platform_application_interfaces_smoke", group="architecture", version="14.4.0", risk="critical", timeout_seconds=180, tags=("v14", "ga", "architecture", "interfaces", "application", "typing", "composition"), profiles=V14_PROFILES, duration_budget_seconds=120, budget_enforced_profiles=V14_PROFILES),
)
