...
_RAW_CHECK_DEFINITIONS: tuple[ReleaseCheckDefinition, ...] = (
    ...
    _callable("v140.interface_application_boundary_smoke", "v14.0 interface and application boundary ratchet", "_v140_interface_application_boundary_smoke", group="architecture", version="14.0", risk="critical", timeout_seconds=120, tags=("v14", "ga", "architecture", "interfaces", "typing", "complexity"), profiles=V14_PROFILES, duration_budget_seconds=60, budget_enforced_profiles=V14_PROFILES),
    ...
    _callable("v140.typing_coverage_ratchet_smoke", "v14.0 typing and coverage ratchet", "_v140_typing_coverage_ratchet_smoke", group="quality", version="14.0", risk="critical", timeout_seconds=180, tags=("v14", "ga", "typing", "coverage", "ratchet"), profiles=V14_PROFILES, duration_budget_seconds=120, budget_enforced_profiles=V14_PROFILES),
    ...
    _callable("v140.reviewer_package_smoke", "v14.0 final reviewer package independent verification", "_v140_reviewer_package_smoke", group="release-check", version="14.0", risk="critical", timeout_seconds=180, tags=("v14", "ga", "reviewer-package", "certification"), profiles=V14_PROFILES, duration_budget_seconds=120, budget_enforced_profiles=V14_PROFILES),
)
