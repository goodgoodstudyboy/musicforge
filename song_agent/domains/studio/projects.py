...
def _mix_info(version: ProjectVersion) -> dict[str, Any]:
    ...
    if state_path.exists():
        try:
            from song_agent.application.legacy_dependencies.mix_controls import mix_state_hash, mix_state_integrity_ok
    ...
    if patch_path.exists():
        try:
            from song_agent.application.legacy_dependencies.mix_controls import mix_patch_hash, mix_patch_integrity_ok
...
def _collect_project_review_tasks(project_dir: Path) -> list[dict[str, Any]]:
    ...
    from song_agent.application.legacy_dependencies.review_judge import REVIEW_JUDGE_TEMPLATE_ID, judge_report_summary, mark_judge_report_stale, read_judge_report_with_stale
    from song_agent.application.legacy_dependencies.review_tasks import ReviewTaskStore, review_candidate_source_breakdown, review_decision_summary, review_task_summary
...
def _collect_project_review_sprints(project_dir: Path) -> list[dict[str, Any]]:
    from song_agent.application.legacy_dependencies.review_sprints import ReviewSprintStore, review_sprint_export_summary
    from song_agent.application.legacy_dependencies.review_sprint_actions import ReviewSprintActionQueueStore, action_queue_collection_summary
    from song_agent.application.legacy_dependencies.review_sprint_metrics import ReviewMetricsStore, sprint_metrics_summary
    from song_agent.application.legacy_dependencies.review_sprint_closeout import closeout_report_summary, signoff_summary
...
def _collect_project_review_metrics_summary(project_dir: Path) -> dict[str, Any]:
    from song_agent.application.legacy_dependencies.review_sprint_metrics import ReviewMetricsStore, project_review_metrics_summary
...
def _collect_project_acceptance_fix_sprint_summary(project_id: str) -> dict[str, Any]:
    from song_agent.application.legacy_dependencies.acceptance_fix_sprints import AcceptanceFixSprintStore, latest_fix_sprint_summary
...
def _collect_project_acceptance_fix_plan_summary(project_id: str) -> dict[str, Any]:
    from song_agent.application.legacy_dependencies.acceptance_fix_planning import AcceptanceFixPlanningStore, latest_fix_plan_summary
...
def _collect_project_acceptance_fix_plan_review_summary(project_id: str) -> dict[str, Any]:
    from song_agent.application.legacy_dependencies.acceptance_fix_plan_reviews import AcceptanceFixPlanReviewStore, latest_fix_plan_review_summary
...
def _collect_project_acceptance_kb_summary(project_id: str) -> dict[str, Any]:
    from song_agent.application.legacy_dependencies.acceptance_kb import AcceptanceKnowledgeBaseStore
