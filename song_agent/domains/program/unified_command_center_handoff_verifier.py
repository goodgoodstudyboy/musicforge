...
def _current_archive_checks(archive_zip_path: Path | str | None, archive_verification_report_path: Path | str | None, source: ImplementationDocument) -> list[ImplementationDocument]:
