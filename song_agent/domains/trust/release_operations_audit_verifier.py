...
from song_agent.domains.trust.release_operations_audit_contracts import OPERATIONS_AUDIT_BLOCKED_KEYS, audit_ledger_hash, audit_ledger_integrity_ok, audit_manifest_integrity_hash, audit_report_integrity_hash
from song_agent.domains.trust.release_operations_signoff_contracts import operations_change_request_hash
...
def write_release_operations_audit_verification_report(report: dict[str, Any], path: Path | str) -> Path:
    return write_json(Path(path), sanitize_metadata(report, blocked_keys=VERIFIER_BLOCKED_KEYS))


def print_release_operations_audit_verification_report(report: dict[str, Any]) -> None:
...
def release_operations_audit_verification_exit_code(report: dict[str, Any]) -> int:
