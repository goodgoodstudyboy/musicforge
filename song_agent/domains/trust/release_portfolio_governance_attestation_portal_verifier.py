...
from song_agent.domains.trust.release_portfolio_governance_attestation_portal_contracts import PORTAL_BLOCKED_KEYS, PORTAL_PACKAGE_TYPE, PORTAL_PAGES, portal_manifest_hash, portal_report_hash, portal_verification_summary
...
def write_release_portfolio_governance_attestation_portal_verification_report(report: dict[str, Any], path: Path | str) -> Path:
    return write_json(Path(path), sanitize_metadata(report, blocked_keys=VERIFIER_BLOCKED_KEYS))


def print_release_portfolio_governance_attestation_portal_verification_report(report: dict[str, Any]) -> None:
...
def release_portfolio_governance_attestation_portal_verification_exit_code(report: dict[str, Any]) -> int:
