...
from song_agent.domains.quality.audio_profiles import AudioProfileStore, AudioProfileNotFoundError
from song_agent.domains.quality.audio_campaign_governance import AudioCampaignGovernanceStore
from song_agent.domains.quality.audio_campaign_remediation_verifier import verify_audio_campaign_remediation_package
...
from song_agent.domains.quality.music_acceptance import AcceptanceStore, acceptance_report_summary, stable_hash
from song_agent.domains.studio.projectio import read_json, write_json
from song_agent.domains.creation.provider import ProviderError, load_provider_config, provider_configured
from song_agent.domains.trust.ga_readiness_contracts import GA_READINESS_PACKAGE_TYPE, GA_READINESS_SCHEMA_VERSION, ga_readiness_integrity_hash, ga_readiness_integrity_ok
...
def build_ga_readiness_report(
    *,
    ...
    unified_release_program_vault_operations_zip_path: Path | str | None = None,
    ...
    unified_release_program_continuity_zip_path: Path | str | None = None,
    ...
    unified_release_program_vault_operations_summary = _unified_release_program_vault_operations_summary(
        required=require_unified_release_program_vault_operations,
        archive_zip_path=unified_release_program_vault_operations_zip_path,
        archive_verification_report_path=unified_release_program_vault_operations_verification_report_path,
        signoff_binding_path=unified_release_program_vault_operations_signoff_binding_path,
    )
    _add_check(
        checks,
        "ga.unified_release_program_vault_operations",
        "passed" if unified_release_program_vault_operations_summary.get("status") == "passed" else "failed" if require_unified_release_program_vault_operations else "warning",
        "blocking" if require_unified_release_program_vault_operations else "warning",
        "Unified Release Program Vault Operations is passed." if unified_release_program_vault_operations_summary.get("status") == "passed" else "Unified Release Program Vault Operations is missing or not passed.",
        unified_release_program_vault_operations_summary,
    )
    unified_release_program_continuity_summary = _unified_release_program_continuity_summary(
        required=require_unified_release_program_continuity,
        archive_zip_path=unified_release_program_continuity_zip_path,
        archive_verification_report_path=unified_release_program_continuity_verification_report_path,
        signoff_binding_path=unified_release_program_continuity_signoff_binding_path,
        vault_operations_archive_path=unified_release_program_vault_operations_zip_path,
        vault_operations_verification_report_path=unified_release_program_vault_operations_verification_report_path,
        vault_operations_signoff_binding_path=unified_release_program_vault_operations_signoff_binding_path,
    )
    _add_check(
        checks,
        "ga.unified_release_program_continuity",
        "passed" if unified_release_program_continuity_summary.get("status") == "passed" else "failed" if require_unified_release_program_continuity else "warning",
        "blocking" if require_unified_release_program_continuity else "warning",
        "Unified Release Program Continuity is passed." if unified_release_program_continuity_summary.get("status") == "passed" else "Unified Release Program Continuity is missing or not passed.",
        unified_release_program_continuity_summary,
    )
    unified_release_program_continuity_kit_summary = _unified_release_program_continuity_kit_summary(
    ...
    _add_check(
        checks,
        "ga.unified_release_program_continuity_kit",
        "passed" if unified_release_program_continuity_kit_summary.get("status") == "passed" else "failed" if require_unified_release_program_continuity_kit else "warning",
        "blocking" if require_unified_release_program_continuity_kit else "warning",
    ...
    unified_release_program_continuity_command_center_summary = _unified_release_program_continuity_command_center_summary(
    ...
    _add_check(
        checks,
        "ga.unified_release_program_continuity_command_center",
        "passed" if unified_release_program_continuity_command_center_summary.get("status") == "passed" else "failed" if require_unified_release_program_continuity_command_center else "warning",
    ...
    report = {
        ...
        "summary": {
            ...
            "unified_release_program_continuity_command_center_status": unified_release_program_continuity_command_center_summary.get("status", "missing"),
