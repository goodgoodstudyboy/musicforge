...
def release_portfolio_governance_final_board_verification_summary(report: DomainDocument) -> DomainDocument:
...
def write_release_portfolio_governance_final_board_verification_report(report: DomainDocument, path: Path | str) -> Path:
    return write_json(Path(path), sanitize_metadata(report, blocked_keys=VERIFIER_BLOCKED_KEYS))


def print_release_portfolio_governance_final_board_verification_report(report: DomainDocument) -> None:
...
def release_portfolio_governance_final_board_verification_exit_code(report: DomainDocument) -> int:
...
class _FinalBoardArchiveVerifier:
    def __init__(
        ...
        *,
        ...
        self.response_summary: ImplementationDocument = {}
        self.change_requests: ImplementationDocument = {}
        self.reviewer_pack_summary: ImplementationDocument = {}
        self.audit_summary: ImplementationDocument = {}
        self.archive_summary: ImplementationDocument = {}
        self.history_entries: list[ImplementationDocument] = []
