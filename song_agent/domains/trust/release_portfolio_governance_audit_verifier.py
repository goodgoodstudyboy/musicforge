...
from song_agent.domains.trust.release_portfolio_governance_audit_contracts import PORTFOLIO_GOVERNANCE_AUDIT_BLOCKED_KEYS as PORTFOLIO_GOVERNANCE_AUDIT_BLOCKED_KEYS, audit_ledger_hash as audit_ledger_hash, audit_ledger_integrity_ok as audit_ledger_integrity_ok, audit_manifest_integrity_hash as audit_manifest_integrity_hash, audit_report_integrity_hash as audit_report_integrity_hash
...
def release_portfolio_governance_audit_verification_summary(report: DomainDocument) -> DomainDocument:
...
def write_release_portfolio_governance_audit_verification_report(report: DomainDocument, path: Path | str) -> Path:
    return write_json(Path(path), sanitize_metadata(report, blocked_keys=VERIFIER_BLOCKED_KEYS))


def print_release_portfolio_governance_audit_verification_report(report: DomainDocument) -> None:
...
def release_portfolio_governance_audit_verification_exit_code(report: DomainDocument) -> int:
...
class _PortfolioGovernanceAuditVerifier:
    def __init__(
        ...
        *,
        ...
        self.portfolio_summary: ImplementationDocument = {}
        self.queue_summaries: ImplementationDocument = {}
        self.signoff_summaries: ImplementationDocument = {}
        self.archive_summaries: ImplementationDocument = {}
    ...
    def _verify_change_request_causality(self) -> None:
        applied_by_id: dict[str, ImplementationDocument] = {}
        applied_by_entry_id: dict[str, ImplementationDocument] = {}
