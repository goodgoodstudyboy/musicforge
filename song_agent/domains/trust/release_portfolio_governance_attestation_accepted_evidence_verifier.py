...
def write_release_portfolio_governance_attestation_accepted_evidence_verification_report(report: DomainDocument, path: Path | str) -> Path:
    return write_json(Path(path), sanitize_metadata(report, blocked_keys=VERIFIER_BLOCKED_KEYS))


def print_release_portfolio_governance_attestation_accepted_evidence_verification_report(report: DomainDocument) -> None:
...
def release_portfolio_governance_attestation_accepted_evidence_verification_exit_code(report: DomainDocument) -> int:
...
class _AcceptedEvidenceVerifier:
    ...
    def _verify_data_bindings(self, source: ImplementationDocument, public: ImplementationDocument) -> None:
