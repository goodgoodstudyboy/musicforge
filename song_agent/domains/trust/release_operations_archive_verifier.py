...
def release_operations_archive_verification_summary(report: DomainDocument) -> DomainDocument:
...
def write_release_operations_archive_verification_report(report: DomainDocument, path: Path | str) -> Path:
    return write_json(Path(path), sanitize_metadata(report, blocked_keys=VERIFIER_BLOCKED_KEYS))


def print_release_operations_archive_verification_report(report: DomainDocument) -> None:
...
def release_operations_archive_verification_exit_code(report: DomainDocument) -> int:
...
class _OperationsArchiveVerifier:
    def __init__(self, zip_path: Path, *, strict: bool, require_signed: bool, max_zip_size_mb: int, max_uncompressed_size_mb: int, max_entry_count: int, now: str | None) -> None:
        ...
        self.package_ledger: ImplementationDocument = {}
        self.change_summary: ImplementationDocument = {}
