...
from song_agent.release_audio_command_center import evidence_to_verifier_kwargs as audio_command_center_evidence_to_kwargs
...
def _ga_component(report_path: Path | str, verification_report_path: Path | str | None) -> dict[str, Any]:
    ...
    runtime_report = verify_ga_readiness_report(report_path, strict=False)
