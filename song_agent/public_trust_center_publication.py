...
from song_agent.public_trust_center_distribution_kit_acceptance import (
    ...
    verification_hash as accepted_evidence_verification_hash,
)
...
class PublicTrustCenterPublicationStore:
    ...
    def verify_publication_zip(self, center_id: str, channel_id: str, publication_id: str | None = None, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        from song_agent.public_trust_center_publication_verifier import verify_public_trust_center_publication_package, write_public_trust_center_publication_verification_report
    ...
    def verify_mirror_directory(self, center_id: str, channel_id: str, publication_id: str, mirror_dir: Path | str, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        from song_agent.public_trust_center_publication_verifier import verify_public_trust_center_publication_mirror, write_public_trust_center_publication_verification_report
