...
from song_agent.audio_health import analyze_wav_health, audio_health_allows_release, audio_health_integrity_ok, audio_health_summary
from song_agent.delivery_qa import build_delivery_qa_report
from song_agent.audio_review_evidence import AudioReviewEvidenceStore, review_integrity_ok, review_payload_hash
from song_agent.final_export import FinalExportOptions, build_final_export_bundle, build_final_export_zip, final_export_dir
from song_agent.mix_controls import (
    ...
    default_mix_state,
    file_sha256,
    marker_to_mix_patch_operations,
    mix_patch_hash,
...
from song_agent.mix_render import _job_state, _project_version_context, _run_summary, _validator_report
from song_agent.projectio import ProjectPaths, append_event, read_json, write_json
from song_agent.project_quality import evaluate_quality_gate, load_quality_gate_config
...
def _candidate_stem_health(*, project_id: str, version_id: str, plan: SongPlan, midi_path: Path, mix_state: dict[str, Any], candidate_dir: Path, now: str) -> dict[str, Any]:
    ...
    from song_agent.stems import build_stem_manifest, write_stem_manifest
