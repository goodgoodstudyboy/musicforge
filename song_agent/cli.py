...
def _main() -> None:
    ...
    if raw_args and raw_args[0] == "generate":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "release-audio-regression":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "release-audio-quality-actions":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "unified-command-center-drift-response":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale", "no_go"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "unified-command-center-release-train-change-control":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale", "no_go"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "unified-command-center-release-train-lifecycle":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale", "no_go"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "unified-command-center-release-train-handoff":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale", "no_go"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "unified-release-program-vault":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale", "no_go"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "unified-release-program-continuity":
        ...
        if result.get("ok") is False or status in {"failed", "blocked", "stale", "no_go"}:
            raise SystemExit(1)
        return
    elif raw_args and raw_args[0] == "unified-release-program-continuity-kit":
    ...
    elif raw_args and raw_args[0] == "verify-release-audio-quality-action-queue-package":
    ...
    elif raw_args and raw_args[0] == "verify-unified-command-center-drift-response-package":
    ...
    elif raw_args and raw_args[0] == "verify-unified-command-center-release-train-change-control-package":
    ...
    elif raw_args and raw_args[0] == "verify-unified-command-center-release-train-lifecycle-package":
    ...
    elif raw_args and raw_args[0] == "verify-unified-command-center-release-train-handoff-package":
    ...
    elif raw_args and raw_args[0] == "verify-unified-release-program-vault-package":
    ...
    elif raw_args and raw_args[0] == "verify-unified-release-program-continuity-package":
    ...
    elif raw_args and raw_args[0] == "verify-unified-release-program-continuity-kit-package":
    ...
    elif raw_args and raw_args[0] == "verify-release-audio-regression-package":
