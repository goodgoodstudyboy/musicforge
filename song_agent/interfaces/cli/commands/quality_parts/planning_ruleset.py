...
def print_planning_ruleset_result(result: dict[str, _InterfaceType]) -> None:
...
def print_planning_simulation_result(result: dict[str, _InterfaceType]) -> None:
    summary = _as_document(result.get("summary"))
...
def print_planning_rule_governance_result(result: dict[str, _InterfaceType]) -> None:
    summary = _as_document(result.get("summary"))
...
def print_planning_rule_impact_result(result: dict[str, _InterfaceType]) -> None:
    summary = _as_document(result.get("summary"))
...
def print_acceptance_kb_result(result: dict[str, _InterfaceType]) -> None:
    summary = _as_document(result.get("summary"))
