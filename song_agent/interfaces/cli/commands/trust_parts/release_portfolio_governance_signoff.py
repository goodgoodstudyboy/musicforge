...
def print_release_portfolio_governance_signoff_result(result: DomainDocument) -> None:
...
def print_release_portfolio_governance_audit_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
    verification = _as_document(result.get("verification_summary"))
...
def print_release_portfolio_governance_reviewer_pack_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
    verification = _as_document(result.get("verification_summary"))
...
def print_release_portfolio_governance_final_board_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
...
def print_release_portfolio_governance_evidence_vault_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
    verification = _as_document(result.get("verification_summary"))
...
def print_release_portfolio_governance_attestation_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
...
def print_release_portfolio_governance_attestation_registry_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
...
def print_release_portfolio_governance_attestation_portal_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
    verification = _as_document(result.get("verification_summary"))
...
def print_release_portfolio_governance_attestation_portal_review_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
...
def print_release_portfolio_governance_attestation_accepted_evidence_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
...
def print_release_portfolio_governance_attestation_transparency_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
...
def print_release_portfolio_governance_attestation_transparency_acknowledgement_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
...
def print_public_trust_center_result(result: DomainDocument) -> None:
    summary = _as_document(result.get("summary"))
    verification = _as_document(result.get("verification"))
