...
from song_agent.interfaces.api.runtime_parts.dependencies.part_005 import ProviderError, RendererError, load_provider_config, load_renderer_config

class BatchRunnerPart004:
