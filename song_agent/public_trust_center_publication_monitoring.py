...
class PublicTrustCenterPublicationMonitoringStore:
    ...
    def verify_monitoring_zip(self, center_id: str, channel_id: str, monitor_id: str, run_id: str, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        from song_agent.public_trust_center_publication_monitoring_verifier import verify_public_trust_center_publication_monitoring_package, write_public_trust_center_publication_monitoring_verification_report
