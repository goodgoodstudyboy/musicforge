    ...
    def generate_node_json(
        ...
        if node_name == "structure_planner":
            return {
                "meter": "4/4",
                "sections": [
                    {"name": "intro", "start_bar": 1, "bars": 4, "energy": 2, "purpose": "set mood"},
                    {"name": "verse", "start_bar": 5, "bars": 8, "energy": 4, "purpose": "state idea"},
                    {"name": "chorus", "start_bar": 13, "bars": 8, "energy": 7, "purpose": "hook"},
                    {"name": "outro", "start_bar": 21, "bars": 4, "energy": 3, "purpose": "resolve"},
                ],
            }
