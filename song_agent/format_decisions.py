...
from song_agent.audio_encoding import AudioEncodingStore, encoded_audio_summary_hash, encoded_audio_summary_integrity_ok, encoded_manifest_integrity_ok, encoded_manifest_uses_fake, normalize_required_profiles, resolve_target_audio_format_profiles
from song_agent.distribution import DistributionStore, DistributionTarget
from song_agent.encoded_audio_acceptance import encoded_audio_acceptance_summary_hash, encoded_audio_acceptance_summary_integrity_ok
from song_agent.projectio import read_json, write_json
from song_agent.projects import ProjectStore, now_iso
from song_agent.redaction import SENSITIVE_VALUE_PATTERNS, sanitize_metadata, sanitize_sensitive_text
...
class FormatDecisionStore:
    ...
    def _read_acceptance_summary(self, release_id: str, profiles: list[str], *, now: str | None = None) -> dict[str, Any]:
        from song_agent.encoded_audio_acceptance import EncodedAudioAcceptanceStore
