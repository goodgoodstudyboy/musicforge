...
class ReleasePortfolioGovernanceAttestationPortalReviewStore:
    def __init__(self, *, portal_store: ReleasePortfolioGovernanceAttestationPortalStore) -> None:
    ...
    def verify_response(self, portfolio_id: str, response_id: str, *, profile: str = "public_summary", now: str | None = None) -> dict[str, Any]:
        from song_agent.release_portfolio_governance_attestation_portal_review_verifier import verify_response_document
