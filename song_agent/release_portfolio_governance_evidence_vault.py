...
from song_agent.release_portfolio_governance import ReleasePortfolioGovernanceStore, queue_integrity_ok, queue_summary
...
def _nested_manifest_integrity_ok(package_type: str, manifest: dict[str, Any]) -> bool:
    ...
    if package_type == "release_portfolio_governance_audit":
        from song_agent.release_portfolio_governance_audit import audit_manifest_integrity_ok
    ...
    if package_type == "release_portfolio_governance_queue":
        from song_agent.release_portfolio_governance import governance_manifest_integrity_ok
