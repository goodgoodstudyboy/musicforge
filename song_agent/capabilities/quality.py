...
QUALITY_CAPABILITIES = (
    CapabilitySpec(
        ...
        gate_policies=("release.audio", "release.audio_strict", "ga.lts"),
        cli_commands=("release-audio-certification",),
        api_routes=("/api/releases/{release_id}/audio-certification",),
        web_panel="Quality",
        release_checks=("v108.release_audio_certification_smoke",),
    ),
    CapabilitySpec(
        ...
        gate_policies=("release.audio", "release.audio_strict", "ga.lts"),
        cli_commands=("release-audio-timeline",),
        api_routes=("/api/releases/{release_id}/audio-timeline",),
        web_panel="Quality",
        release_checks=("v109.release_audio_timeline_smoke",),
    ),
)
