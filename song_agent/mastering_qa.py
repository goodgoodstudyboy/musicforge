...
from song_agent.audio_health import analyze_wav_health, audio_health_integrity_ok, audio_health_summary
from song_agent.final_export import final_export_dir
from song_agent.mastering_profiles import MasteringProfile, MasteringProfileError, MasteringProfileStore, mastering_profile_hash
from song_agent.projectio import read_json, write_json
from song_agent.projects import ProjectStore, now_iso
from song_agent.redaction import sanitize_metadata, sanitize_sensitive_text
from song_agent.releases import BLOCKED_RELEASE_KEYS, ReleaseDocument, ReleaseStateError, ReleaseStore, stable_hash
...
def _release_stub_from_analysis(analysis: dict[str, Any]) -> ReleaseDocument:
    from song_agent.releases import ReleaseDocument, ReleaseTrack
