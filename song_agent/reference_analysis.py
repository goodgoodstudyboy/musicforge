...
from song_agent.assets import AssetStore, asset_public_dict
...
from song_agent.references import ReferenceItem, ReferenceStore, reference_file_path
...
def reference_context(store: ReferenceStore, reference_id: str) -> ReferenceContext:
