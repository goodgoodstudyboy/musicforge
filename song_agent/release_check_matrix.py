...
CHECK_DEFINITIONS: tuple[ReleaseCheckDefinition, ...] = (
    ...
    _callable("v80.public_trust_center_smoke", "v8.0 public trust center smoke", "_v80_public_trust_center_smoke", group="trust", version="8.0", risk="critical", timeout_seconds=600, tags=("v8", "trust", "portal", "attestation"), profiles=("full", "quick", "latest"), expected_warnings=("Duplicate name:",)),
)
