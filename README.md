...
current guard evidence before Hub readiness is accepted.
...
python -m song_agent.cli trust-operations-incident-knowledge --hub-id hub-default --refresh --create-guard --run-all-guards --refresh-recurrence --export --zip --verify --strict --require-guards-passed --require-no-open-recurrence --incident-board-verification-report path\to\incident-verification-report.json --hub-verification-report path\to\hub-verification-report.json --json
python -m song_agent.cli verify-trust-operations-incident-knowledge-package path\to\trust-operations-incident-knowledge.zip --strict --require-guards-passed --require-no-open-recurrence --incident-board-verification-report path\to\incident-verification-report.json --hub-verification-report path\to\hub-verification-report.json --json
